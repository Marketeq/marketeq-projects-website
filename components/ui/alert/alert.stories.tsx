...
const meta: Meta = {
  ...
  parameters: {
    design: {
      type: "figma",
      url: "https://www.figma.com/file/CgaxYAFROXbQH5fgPw8sX4/Blend-Metrics---New-Design-System?type=design&node-id=111-196223&mode=design&t=YLOI4d2ESB2QHIgZ-4",
    },
  },
}
    ...
    <Alert {...args}>
      ...
      <AlertContent>
        ...
        <div className="mt-3 flex items-center gap-x-3 text-sm font-semibold">
          ...
          <Link
            className="flex items-center gap-x-2 text-success-600 hover:underline focus-visible:outline-hidden "
            href="/"
          >
            View changes
            <ArrowRight />
    ...
    <Alert {...args}>
      ...
      <AlertContent>
        ...
        <div className="mt-3 flex items-center gap-x-3 text-sm font-semibold">
          ...
          <Link
            className="flex items-center gap-x-2 text-primary-600 hover:underline focus-visible:outline-hidden"
            href="/"
          >
            View changes
            <ArrowRight />
    ...
    <Alert {...args}>
      ...
      <AlertContent>
        ...
        <div className="mt-3 flex items-center gap-x-3 text-sm font-semibold">
          ...
          <Link
            className="flex items-center gap-x-2 text-gray-600 hover:underline focus-visible:outline-hidden"
            href="/"
          >
            View changes
            <ArrowRight />
    ...
    <Alert {...args}>
      ...
      <AlertContent>
        ...
        <div className="mt-3 flex items-center gap-x-3 text-sm font-semibold">
          ...
          <Link
            className="flex items-center gap-x-2 text-error-600 hover:underline focus-visible:outline-hidden"
            href="/"
          >
            View changes
            <ArrowRight />
    ...
    <Alert {...args}>
      ...
      <AlertContent>
        ...
        <div className="mt-3 flex items-center gap-x-3 text-sm font-semibold">
          ...
          <Link
            className="flex items-center gap-x-2 text-warning-600 hover:underline focus-visible:outline-hidden"
            href="/"
          >
            View changes
            <ArrowRight />
...
export const DisasterRecovery = () => {
  return (
    ...
    >
      ...
      <Link
        className="mt-3 inline-flex items-center gap-x-2 text-sm font-semibold text-primary-500 hover:underline focus-visible:outline-hidden"
        href="/"
      >
        Learn more
        <ExternalLink />
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex items-center gap-x-3">
        <button className="text-sm font-semibold text-gray-600 hover:underline focus-visible:outline-hidden">
          Dismiss
        </button>
        <Link
          className="text-sm font-semibold text-primary-500 hover:underline focus-visible:outline-hidden"
          href="/"
        >
          Upgrade plan
        </Link>
