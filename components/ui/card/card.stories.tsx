...
export const ActionEmpty = () => {
  return (
    <article className="w-[317px] shadow-xs border rounded-lg border-primary-500 p-6 bg-white">
      <div className="flex items-center justify-between">
        <h1 className="text-base font-medium grow leading-6 text-gray-900">
          Select Action
        </h1>
      ...
      <button className="h-[60px] bg-white w-full mt-6 flex items-center justify-center gap-x-3 text-lg font-semibold border focus-visible:outline-hidden text-gray-800 border-gray-300 shadow-2xs px-4">
    ...
    <article className="w-[317px] shadow-xs border rounded-lg border-primary-500 p-6 bg-white">
      ...
      <div className="border p-4 mt-6 border-gray-200 rounded-lg flex items-start bg-white gap-x-2.5">
        ...
        <div className="flex grow items-start">
          ...
          <button className="focus-visible:outline-hidden h-5 w-5">
...
export const ActionConditionalAddVariant = () => {
  return (
    <div className="inline-flex flex-col items-center space-y-6">
      ...
      <button className="h-[41px] focus-visible:outline-hidden mx-auto w-[41px] inline-flex bg-[#576190]/10 items-center justify-center rounded-full">
      ...
      >
        <AccordionTrigger asChild>
          <div className="flex justify-between w-full items-center p-3">
            ...
            <button className="h-8 w-8 rounded-[5px] focus-visible:outline-hidden inline-flex items-center justify-center">
