...
const checkboxVariants = cva(
  "inline-flex flex-none items-center justify-center rounded-[5px] border-[1.5px] border-gray-300 text-white group-hover:border-primary-400 group-hover:ring-3 group-hover:ring-primary-50 group-focus:ring-3 group-focus:ring-primary-50 group-disabled:border-gray-200 group-disabled:text-gray-200 group-hover:group-disabled:border-gray-200 group-hover:group-disabled:ring-0 group-data-[state=checked]:border-primary-500 group-data-[state=checked]:bg-primary-500 group-data-[state=checked]:group-disabled:border-gray-200 group-data-[state=checked]:group-disabled:bg-gray-50",
  {
    variants: {
      size: {
        sm: "h-4 w-4",
