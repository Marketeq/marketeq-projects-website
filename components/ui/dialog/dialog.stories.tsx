    ...
    <Dialog>
      ...
      <DialogContent className="max-w-none w-[396px]">
        <DialogHeader className="flex-row gap-x-2">
          <DialogTitle className="grow">Rename this Version</DialogTitle>
...
export const Name = () => {
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-none w-[396px]">
        <DialogHeader className="flex-row gap-x-2">
          <DialogTitle className="grow">Name this Version</DialogTitle>
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[396px]">
        <DialogHeader>
          <div className="flex items-center justify-between">
            <DialogTitle className="grow">Save to Collection?</DialogTitle>
            <DialogClose asChild>
              <IconButton
