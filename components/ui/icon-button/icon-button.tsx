...
const iconButtonVariants = cva(
  "inline-flex items-center justify-center shrink-0 whitespace-nowrap gap-x-2 rounded-[5px] font-semibold transition-colors focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      visual: {
        primary: "",
