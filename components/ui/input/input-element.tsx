...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      className={cn(
        "absolute inset-y-0 right-0 my-auto flex w-(--w,44px) items-center justify-center peer-disabled:cursor-not-allowed peer-disabled:opacity-50",
        className
      )}
      style={{ ...style }}
      ref={ref}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      className={cn(
        "absolute inset-y-0 left-0 my-auto flex w-(--w,44px) items-center justify-center peer-disabled:cursor-not-allowed peer-disabled:opacity-50",
        className
      )}
      style={{ ...style }}
      ref={ref}
