...
const pinInputVariants = cva(
  "rounded-lg border border-gray-300 p-2 text-center font-medium text-gray-300 shadow-2xs placeholder:text-gray-300 focus:border-primary-500 focus:ring-primary-500 disabled:opacity-50",
  {
    variants: {
      size: {
