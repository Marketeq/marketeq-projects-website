      ...
      <ScrollArea className="h-[calc(theme(height.full)-69px)] overflow-y-auto px-[15px] pt-[15px]">
        ...
        <div className="mt-2 space-y-2 divide-y divide-gray-200">
          <div className="space-y-2">
            <Link
              className="group flex items-center justify-between rounded-[5px] px-3 py-2 hover:bg-gray-100 focus:bg-primary-50 focus:text-primary-500 focus-visible:outline-hidden disabled:opacity-50"
              href="/"
            >
  ...
  return (
    <nav className="z-20 h-screen w-[224px] overflow-y-auto border-r border-gray-200 bg-gray-50 p-[15px] pb-0 scrollbar-thin scrollbar-thumb-rounded-lg">
      <ul className="grid gap-2">
        <li>
          <Link
            className="flex h-10 cursor-pointer items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold leading-6 text-gray-500 focus:bg-primary-50 focus:text-primary-500 focus-visible:outline-hidden"
            href="#"
          >
            <ShieldZap />
            Dashboard
    ...
    <div className="w-[386px] h-[683px] relative bg-white py-5 shadow-[0px_4px_30px_0px_rgba(0,0,0,0.05)]">
      <div className="px-5 pb-2 h-[76px] space-y-3">
        ...
        <SearchField className="w-full">
          ...
          {query && (
            <button
              className="focus-visible:outline-hidden whitespace-nowrap absolute text-sm font-semibold text-gray-500 top-1/2 -translate-y-1/2 right-2.5"
              onClick={resetQuery}
            >
              Clear
            </button>
        ...
        <VersionCardRoot className="group">
          <VersionCardHeader>
            ...
            <div className="flex items-center gap-x-3.5">
              <Favorite className="data-[state=off]:hidden group-hover:data-[state=off]:inline-flex group-hover:group-active:data-[state=off]:inline-flex" />
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <IconButton
    ...
    <div className="h-[683px] w-[386px] pt-5 bg-white border-r border-gray-200 shadow-[0px_4px_30px_0px_rgba(0,0,0,0.05)]">
      <div className="px-5 pb-5 border-b border-gray-200">
        <SearchField className="w-full">
          ...
          {query && (
            <button
              className="focus-visible:outline-hidden absolute top-1/2 -translate-y-1/2 right-3 text-sm font-semibold text-gray-500"
              onClick={resetQuery}
            >
              Clear
            </button>
            ...
            <>
              <div className="mt-6 pb-5 space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <article className="group relative py-3 flex items-center px-[25px] gap-x-1 h-[68px] rounded-lg border-2 border-gray-200 bg-white shadow-[0px_1px_5px_0px_rgba(16,24,40,0.02)]">
                    <button className="focus-visible:outline-hidden cursor-grab absolute left-1 inset-y-0 my-auto">
                    ...
                    <div className="flex items center">
                      <ButtonGroup className="inline-flex opacity-0 group-hover:opacity-100 transition duration-300 items-center gap-x-1">
                        <TooltipProvider delayDuration={75}>
                          <Tooltip>
                            <TooltipTrigger className="focus:outline-hidden">
                      ...
                      <button className="focus-visible:outline-hidden h-[18px] w-[18px]">
              ...
              <div className="mt-6 flex items-center justify-between">
                <div className="inline-flex items-center gap-x-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger className="focus-visible:outline-hidden">
            ...
            <>
              <div className="mt-6 space-y-3">
                ...
                <div className="group h-[92px] rounded-lg border-gray-200 border p-3 relative pl-[25px]">
                  <button className="focus-visible:outline-hidden opacity-0 group-hover:opacity-100 duration-300 absolute left-2 inset-y-0 cursor-grab my-auto">
            ...
            <Listbox>
              ...
              <ListboxContent className="mt-1.5">
                <div className="items-center flex gap-x-2.5">
                  <ListboxButton className="grow" />
                  <button className="focus-visible:outline-hidden">
