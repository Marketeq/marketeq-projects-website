...
const switchVariants = cva(
  "peer inline-flex shrink-0 cursor-pointer items-center rounded-full p-0.5 transition-colors focus:ring-2 focus:ring-offset-2 focus-visible:outline-hidden disabled:cursor-not-allowed disabled:bg-gray-200 disabled:opacity-50 data-[state=checked]:disabled:bg-gray-200",
  {
    variants: {
      size: {
        sm: "h-5 w-9",
...
const thumbVariants = cva(
  "pointer-events-none block rounded-full bg-white shadow-xs transition-transform data-unchecked:translate-x-0",
  {
    variants: {
      size: {
        sm: "h-4 w-4",
